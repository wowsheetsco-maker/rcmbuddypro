...
import { Users, Package, FileText, BarChart3, MessageSquare, ListChecks } from "lucide-react";
...
const TILES = [
  ...
  { to: "/wellness/cases",     icon: ListChecks, title: "Cases (Inbox + Tracker)", desc: "Inbox for new requests plus the master tracker — status, schedule, invoice & last delivery." },
