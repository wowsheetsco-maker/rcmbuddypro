...
import { Users, Package, Inbox, FileText, BarChart3, MessageSquare, ListChecks } from "lucide-react";
...
const TILES = [
  ...
  { to: "/wellness/cases",     icon: ListChecks, title: "All Cases", desc: "Master tracker for every case with status, provider, schedule, invoice & last delivery." },
